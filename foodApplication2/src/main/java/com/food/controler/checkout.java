...
// save the order to the database
			...
			int menuId=cart.getItems().values().iterator().next().getMenu_id();
			int quantity=cart.getItems().values().iterator().next().getQuantity();
			int itemtotal=(int)session.getAttribute("total");
			...
			OrderItemsDao orderdaoimpl=new OrderItemsDaoImpl ();
			orderdaoimpl.insert(orderitem);*/
